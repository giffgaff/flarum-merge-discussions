...
class MergeFailedBlueprint implements BlueprintInterface, MailableInterface
{
    public MergeDiscussion $mergeDiscussionCommand;
    public \Exception $exception;

    public function __construct(MergeDiscussion $command, \Exception $e)
    {
    ...
    {
        return 'fofMergeDiscussionFailed';
    }
    ...
    {
        return ['text' => 'fof-merge-discussions::emails.mergeFailed'];
    }
    ...
    {
        return $translator->trans('fof-merge-discussions.email.subject.merge_failed');
    }
