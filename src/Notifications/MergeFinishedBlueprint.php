...
class MergeFinishedBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    {
        return 'fofMergeDiscussionFinished';
    }
    ...
    {
        return ['text' => 'fof-merge-discussions::emails.mergeFinished'];
    }
    ...
    {
        return $translator->trans('fof-merge-discussions.email.subject.merge_finished');
